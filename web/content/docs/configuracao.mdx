...
<img
  src="/images/docs/configuracao/config-editor.png"
  alt="Configuração aberta no editor"
/>

**Como tirar**: print do `config.yml` aberto destacando `break`, `spawner` e `rarities`.
